        ...
        <div class="chart-track-list">
          <div class="track__item">
            ...
            >
              ...
              <br />
              {{ song.artists }}
              <div class="chart-category-box">
                <p class="chart-category-text">{{ song.category }}</p>
              </div>
            </button>
          </div>
        </div>
      </div>
      <div class="authers-box">
        <div class="authors-period-line">
          <h2 class="authors-h2">Авторы</h2>
        </div>
        <div class="authers-list">
          <div class="authors-line">
            <div
              class="authors-icon-text"
              v-for="artist in artists"
              :key="artist.name"
            >
            <router-link to="/artist">
              <img
                :src="require(`../assets/images/artists/${artist.photo}.png`)"
                class="authors-icon"
              />
            </router-link>

              <div class="authors-text">{{ artist.name }}</div>
            </div>
          </div>
        </div>
      </div>
...
import artists from "../data/data.artists";
import Chartsongs from "../data/data.chart";
