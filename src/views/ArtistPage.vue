  ...
  <div class="artist">
    <div class="wrapper">
      <div class="artist__info">
        <img src="https://sun9-26.userapi.com/s/v1/if1/QBGPCROk5plZ9zsJVYcTOwSTHhhZ-lLr-l2n5-Uh5ORs_O1nSmXD5IbZQpEyI-n93zEcWHa1.jpg?size=400x400&quality=96&crop=80,80,639,639&ava=1" alt="artist_photo" class="artist-photo-big"/>
        <div class="artist__descr">
          <h3 class="artist__name">{{ name }}</h3>
          <router-link to="/load" class="goLoad"
            >Редактировать профиль</router-link
          >
          <div id="nav" v-if="$store.state.artist">
            <button class="Logout" @click="$store.dispatch('logout')">
              Выйти
            </button>
          </div>
        </div>
            ...
            >
              ...
              <defs>
                <linearGradient
                  ...
                  x2="16"
                  y2="31.7627"
                  gradientUnits="artistSpaceOnUse"
                >
      ...
      <div class="artist_playlist">
        <h3 class="playlist__title">Популярные треки</h3>
        <div class="search">
      ...
      <div class="about">
        <div class="albums__artist">
          <h3 class="about__artist_title"> Все альбомы </h3>
          <div class="album-list">
            <div class="album">
              <img src="https://i.pinimg.com/originals/14/a2/0c/14a20c739200d3fde327d365941890bc.jpg"
             alt="album_photo" class="album_photo">
              <img src="https://is5-ssl.mzstatic.com/image/thumb/Music113/v4/3d/48/13/3d4813da-8601-6a6e-067c-0f398ed30c79/cover.jpg/1200x1200bf-60.jpg"
             alt="album_photo" class="album_photo">
            </div>
            <div class="album">
              <img src="https://www.rap.ru/upload/img/9222.jpg"
             alt="album_photo" class="album_photo">
              <img src="https://i1.sndcdn.com/artworks-000105638230-vjra3u-t500x500.jpg"
             alt="album_photo" class="album_photo">
            </div>
            <div class="album">
              <img src="https://lastfm.freetls.fastly.net/i/u/ar0/07e014f356f45f151d3f1bf3b60091b2.jpg"
             alt="album_photo" class="album_photo">
              <img src="https://i.pinimg.com/originals/5f/37/30/5f373045ff0b616485febbaf5b2d6cba.jpg"
             alt="album_photo" class="album_photo">
            </div>
        ...
        <div class="about__artist">
          <h3 class="about__artist_title"> Об артисте </h3>
          <p class="about_p_artist">Ади́ль Оралбе́кович Жале́лов, урожд. — Кулмагамбе́тов, более известный под сценическим псевдонимом Скриптони́т,
             — казахстанский исполнитель и музыкальный продюсер, основатель лейбла Musica36</p>
        </div>
      </div>
    </div>
...
export default {
  ...
  setup() {
    ...
    onBeforeMount(() => {
      const artist = auth.currentartist;
      if (artist) {
        name.value = artist.email.split("@")[0];
      }
